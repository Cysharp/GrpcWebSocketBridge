...
namespace System.Buffers
{
    ...
    {
        public static void ThrowArgumentOutOfRangeException_OffsetOutOfRange() => throw new ArgumentOutOfRangeException();
    ...
    internal ref partial struct SequenceReader<T> where T : unmanaged, IEquatable<T>
    {
        ...
        public SequenceReader(ReadOnlySequence<T> sequence)
        {
            ...
            //sequence.GetPosition(out ReadOnlySpan<T> first, out _nextPosition);
