...
public static class PackageExporter
{
    ...
    {
        const string PackageName = "GrpcWebSocketBridge";
        ...
        {
            "Assets/Plugins/Grpc.Core.Api",
            "Assets/Plugins/Grpc.Net.Client",
            "Assets/Plugins/Microsoft.Extensions.Logging.Abstractions",
            "Assets/Plugins/System.Buffers",
            "Assets/Plugins/System.Diagnostics.DiagnosticSource",
            "Assets/Plugins/System.IO.Pipelines",
            "Assets/Plugins/System.Memory",
            "Assets/Plugins/System.Runtime.CompilerServices.Unsafe",
            "Assets/Plugins/System.Threading.Tasks.Extensions",
        };

        var path = Path.Combine(Application.dataPath, root);
        var assets = Directory.EnumerateFiles(path, "*", SearchOption.AllDirectories)
            .Where(x => Path.GetExtension(x) == ".cs" || Path.GetExtension(x) == ".asmdef" || Path.GetExtension(x) == ".json" || Path.GetExtension(x) == ".meta" || Path.GetExtension(x) == ".jslib")
