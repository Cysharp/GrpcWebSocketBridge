...
namespace Grpc.Net.Client.Internal
{
    ...
    {
        // NOTE(Cysharp): Unity 2019.4's IL2CPP processor cannot handle 'init' related instructions.
        // If a property setter is declared as 'init', IL2CPP processor reports following a error.
        //   Additional information: Attempting to return a value from method
        //   'Grpc.Net.Client.Internal.RetryPolicyInfo Grpc.Net.Client.Internal.GrpcMethodInfo::CreateRetryPolicy(Grpc.Net.Client.Configuration.RetryPolicy)'
        //   when there is no value on the stack. Is this invalid IL code?
        public int MaxAttempts { get; set; }
        public TimeSpan InitialBackoff { get; set; }
        public TimeSpan MaxBackoff { get; set; }
        public double BackoffMultiplier { get; set; }
        public List<StatusCode> RetryableStatusCodes { get; set; } = default!;
    }
    ...
    internal class HedgingPolicyInfo
    {
        ...
        public List<StatusCode> NonFatalStatusCodes { get; set; } = default!;
    }
}
